# CompileDraftTool
-UPDATED Jul 14, 2026- Added MN03 and AX03, Styles Updated
(Styles taken from https://github.com/chuckplayer/compile )
Drafting tool for the Compile card game.

These are my original python scripts.
DBtool.py is a python tool to take a csv file, formatted and named like the included protocols.csv, to create a properly formatted protocols.json. It can also be used to append new entries to protocols.json.
